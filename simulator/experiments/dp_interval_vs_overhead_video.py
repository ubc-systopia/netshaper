...
def dp_interval_vs_overhead_video_unidirectional(config: configlib.Config, filtered_data_list):
    ...
    dp_intervals = config.dp_intervals_us    
     
    with tqdm(total=len(video_nums_list)*len(dp_intervals)*len(noise_multipliers_s_to_c)) as pbar:
