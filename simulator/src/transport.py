...
def DP_transport(data, app_time_resolution_us, transport_type, DP_mechanism,  epsilon_per_query, DP_step_, data_time_resolution_us, verbose=True):
  ...
  if(transport_type == "DP_wPrivacy"):
    return DP_transport_wPrivacy(app, DP_step, DP_mechanism, epsilon_per_query)
  elif(transport_type == "DP_dynamic"):
    return DP_transport_dynamic(app, DP_step, DP_mechanism, epsilon_per_query, verbose)
...
def NonDP_transport(app_time_resolution_us):
  app = Application(app_time_resolution_us)
